...
import com.axxiscomputo.dao.UserDao;
...
import com.axxiscomputo.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.axxiscomputo.service.UserService")
